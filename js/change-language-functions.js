var languageContent = {
    greek: {
      ...
      footerText: "Αυτό το έργο δημιουργήθηκε για τις ανάγκες της εργασίας μας κατά τη διάρκεια των σπουδών μας στο Πανεπιστήμιο Μακεδονίας:",
      and: "και",
      student2: "Δημου Αλεξιος",
      ...
      thankYou: "Ευχαριστούμε! Θα σας απαντήσουμε σύντομα.",
      restartButton: "Επανεκκίνηση Ερωτηματολογίου",
    },
    english: {
      languageBtn: "EN",
      mainTitle: "Family Status Certificate",
      pageTitle: "Family Status Certificate",
      infoTitle: "Information on the issue of Family Status Certificate",
      subTitle1: "This questionnaire can help you determine if you are eligible to receive the Family Status Certificate.",
      ...
      thankYou: "Thank you! We will answer you soon.",
      restartButton: "Restart Questionnaire",
    }
};
